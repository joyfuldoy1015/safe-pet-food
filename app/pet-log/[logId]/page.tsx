...
import LogProductSummaryCard from './LogProductSummaryCard'
import LogReviewSection from './LogReviewSection'
import LogOwnerProfileStrip from './LogOwnerProfileStrip'
...
export default function LogDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      {/* 프로필 영역 */}
      <LogOwnerProfileStrip
        owner={owner}
        pet={pet}
        onNavigateToOwner={() => router.push(`/owners/${owner.id}`)}
      />

      {/* 제품 정보 카드 */}
      <LogProductSummaryCard log={log} daysUsed={daysUsed} formatDate={formatDate} />
